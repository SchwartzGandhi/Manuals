...
def before_extend_hint_information(hint_data, world: World, multiworld: MultiWorld, player: int):
    return hint_data

def after_extend_hint_information(hint_data, world: World, multiworld: MultiWorld, player: int):
    return hint_data
